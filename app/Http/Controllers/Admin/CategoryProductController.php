...
class CategoryProductController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        try {
            $status = Status::all();
            if (count($status) == 0) return redirect()->back()->with('fail', 'Please add a status');
        } catch (\Throwable $th) {
            return redirect()->back()->with('fail', 'Impossible to implement');
        }
    ...
    public function create(Request $request)
    {
        ...
        try {
            ...
            redirect()->back()->with('fail', 'catrgory product create fial');
        }
    ...
    public function delete($id)
    {
        ...
        try {
            ...
            return redirect()->back()->with('fail', 'Impossible to delete');
        }
    ...
    public function edit(Request $request, $id)
    {
        try {
            ...
            return redirect()->back()->with('fail', 'Impossible to edit');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
           ...
           return redirect()->back()->with('fail', 'catrgory product update fail');
        }
