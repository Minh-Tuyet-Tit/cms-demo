        ...
        <div class="col-md-3">
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title">Update Image Slide Show</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form method="post" action="{{ url('admin/imageslideshow/update/' . $slide->id) }}">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <!-- text input -->
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="link_pro" type="text" class="form-control"
                                        value="{{ $slide->link_pro }}" placeholder="Enter link product" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="text_head" type="text" class="form-control"
                                        value="{{ $slide->text_head }}" placeholder="Enter text head" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="text_content" type="text" class="form-control"
                                        value="{{ $slide->text_content }}" placeholder="Enter text content" />
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <!-- select -->
                                <div class="form-group">
                                    <label>Image Slide Show</label>
                                    <select name="status" class="form-control">

                                        @foreach ($status as $st)
                                            <option value="{{ $st->id }}"
                                                {{ $st->id == $slide->status ? 'selected' : '' }}>{{ $st->status_name }}
                                            </option>
                                        @endforeach
                        ...
                        <div>
                            ...
                            <a style="float: right" href="{{ url('admin/imageslideshow') }}" class="btn btn-danger"
