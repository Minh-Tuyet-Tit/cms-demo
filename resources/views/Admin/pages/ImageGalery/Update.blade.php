                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        ...
                                        @foreach ($status as $st)
                                            <option value="{{ $st->id }}" {{$st->id==$slide->status?'selected': ''}}>{{ $st->status_name }}</option>
                                        @endforeach
                    ...
                    <table class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $slide)
                                <tr>
                                    <td>{{ $slide->id }}</td>
                                    <td style="word-wrap:break-word; width: 20%; overflow: hidden;"><img style="width:100%"
                                            src="{{ $slide->url }}" alt="img">
                                    </td>
                                    <td>
                                        <p>{{ $slide->link }}</p>
                                    </td>
                                    <td>
                                        {{ $slide->statusImageGalery->status_name }}
                                    </td>
                                    <td>
